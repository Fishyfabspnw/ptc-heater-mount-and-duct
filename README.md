...
2. Implement a 121c thermal cutoff fuse to the power loop. (i drilled and used a rivot, and ring terminal around the rivot then attatched the 121c thermal cutoff fuse to that and bent it so it was making contact with the heater, i also applied boron nitrade paste here)
